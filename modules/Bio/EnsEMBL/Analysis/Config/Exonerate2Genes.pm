...
%Config = (
  EXONERATE_CONFIG_BY_LOGIC => {
    ...
    cdna_update => {
      ...
      GENOMICSEQS => '/data/blastdb/Ensembl/human/GRCh38/genome/softmasked_dusted/toplevel.with_nonref.with_masked_duplicates.full_Y_with_Ns.without_MT.fa',
      KILL_TYPE => undef,
      OPTIONS => '--model est2genome --forwardcoordinates FALSE --softmasktarget TRUE --exhaustive FALSE  --score 500 --saturatethreshold 100 --dnahspthreshold 60 --dnawordlen 14',
      OUTDB => 'ESTCDNA_DB',
      QUERYSEQS => '/lustre/scratch109/ensembl/kb15/human/cDNA_update/chunks',
      QUERYTYPE => 'dna',
      USE_KILL_LIST => 0
    },
    cdna_update_2 => {
      ...
      OUTDB => 'ESTCDNA_DB',
      QUERYSEQS => '/lustre/scratch109/ensembl/kb15/human/cDNA_update/chunks2',
      QUERYTYPE => 'dna',
      USE_KILL_LIST => 0
    },
    cdna_update_3 => {
      ...
      OPTIONS => '--model est2genome --forwardcoordinates FALSE --maxintron 400000 --bestn 10 --softmasktarget FALSE --exhaustive FALSE  --score 500 --saturatethreshold 100 --dnahspthreshold 60 --dnawordlen 14',
      OUTDB => 'ESTCDNA_DB',
      QUERYSEQS => '/lustre/scratch109/ensembl/kb15/human/cDNA_update/chunks3',
      QUERYTYPE => 'dna',
      USE_KILL_LIST => 0
    },
    orthologue_recovery => {
