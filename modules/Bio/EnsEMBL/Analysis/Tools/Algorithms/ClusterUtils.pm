...
sub make_types_hash {
    ...
    # print "BK_DEBUG::ClusterUtils:: function make_types_hash \n";
...
sub make_types_hash_with_genes { 
   ...
   print "DEBUG_BK::ClusterUtils::make_types_hash_with_genes:: $gene_set1,$gene_set2,$gene_set1_name, $gene_set2_name \n";
