...
sub run{
  ...
  # print Dumper(\%types_hash);
  # print "BK::###Dumper end type printing\n";

  # print "BK::###Dumper start data printing\n";
  # print Dumper(\@{$self->set_2_prot_genes});
  # print "BK::###Dumper end data printing\n";
  ...
  # print "BK::###Dumper start gene printing\n";
  # print Dumper(\@cdna_gene_clusters_with_pc);
  # print "BK::###Dumper end gene printing\n";
  ...
  # for my $g_tmp (@unclustered_cdna_genes) {
	# print "BK_DEBUG::lincRNAFInder:: " . $g_tmp->id() . "\n";
  # }
  ...
  # print "BK::###Dumper start efg_simple_feature_genes printing\n";
  # print Dumper(\@efg_sfg);
  # print "BK::###Dumper end efg_simple_feature_genes printing\n";
  ...
  # print "BK::###Dumper start unclust_efg printing\n";
  # print Dumper(\@unclust_efg);
  # print "BK::###Dumper end unclust_efg printing\n";
  ...
  # print scalar(@{$self->result_set}) . " for 4 step \n";
  ...
  # RG: for my $rg( @{$self->result_set}  ) {   
    ...
    # print "BK_DEBUG::  Could compute translation for cDNA: gene dbID ". $new_gene->display_id . " " . $new_gene->seq_region_name . " " . 
    #         $new_gene->seq_region_start . " " . $new_gene->seq_region_end ." $new_gene\n";
    print scalar(@{ $new_gene->get_all_Transcripts} ) ." translations found for gene " . $rg->display_id . " gene: " . $rg . " \n";
  ...
  #open (TRS, '>>/nfs/users/nfs_k/kb15/BKtmp/linc_proteins2.tmp');
  # print TRS "BK::###Dumper start short printing\n";
  # print TRS Dumper(@$short);
  # print TRS "BK::###Dumper end short printing\n";
  #close (TRS);
...
sub filter_genes_with_long_translations {  
  ...
  GENES: for my $g ( @$capped_longest_genes ) { 
    for my $t ( @{$g->get_all_Transcripts } ) {   
       ...
       # print "BK_DEBUG::lincRNAFinder::filter_genes_with_long_translations:: trnanslation multiplied by 3: $tl_length and $tr_length \n";
...
sub update_efg_feature_genes {  
  ...
  # print "DEBUG_BK:: This should not return anything!!\n\n\n\n";
...
sub update_and_copy_cdna {   # This runnable method is only called by the runnableDB when DEBUG option is turned on.
  ...
  # print "DEBUG_BK::lincRNAFinder :: update_and_copy_cdna : how many Genes!! " . scalar(@$array) . " ...\n\n";

  for my $g ( @$array) { 
  	print "DEBUG_BK::lincRNAFinder :: update_and_copy_cdna :: " . $g->id . " " . $g->biotype . "  \n";
    $g->biotype($new_bt);  
